...
public class AStarNode implements Comparable<AStarNode> {
    ...
    public Map<SavedValues, Double> savedValues = new HashMap<>();
    ...
    private List<AStarHeuristic> heuristicList;
    public AStarNode(BlockPos pos, AStarNode parentNode, AStarNode endNode, List<AStarHeuristic> heuristicList) {
        this.x = pos.getX();
        this.y = pos.getY();
        this.z = pos.getZ();
        this.blockPos = pos;
    ...
    public AStarNode(int xRel, int yRel, int zRel, AStarNode parentNode, AStarNode endNode, List<AStarHeuristic> heuristicList) {
    ...
    public AStarNode(BlockPos pos, AStarNode endNode , List<AStarHeuristic> heuristicList) {
        this.x = pos.getX();
        this.y = pos.getY();
        this.z = pos.getZ();
        this.blockPos = pos;
    ...
    public AStarNode(BlockPos pos, List<AStarHeuristic> heuristicList) {
        this.x = pos.getX();
        this.y = pos.getY();
        this.z = pos.getZ();
        this.heuristicList = heuristicList;
    ...
    private void calculateHeuristic(AStarNode endNode) {
        ...
        for(AStarHeuristic h : heuristicList) {
            hCost += h.getHeuristic(this);
        }
    }
