...
public class LookUtil {
    ...
    public static Tuple<Double, Double> getAngles(Vec3 pos) {
        Entity player = Minecraft.getMinecraft().thePlayer;
        return getAngles(player.getPositionVector().addVector(0, player.getEyeHeight(), 0), pos.addVector(0.5f, 0.5f, 0.5f), player.rotationYaw);
    }
