package com.rogerr.splinefinder.util;
...
public class Util {
    ...
    // Given normalised vectors, this will return the side 'vec' would have been if in the direction vec points to it intersects source.


    // therefore this function returns if it is on the right.
    public static boolean leftRightVec2D(Vec3 source, Vec3 vec) {
        Vec3 cross = source.crossProduct(vec);
        return cross.yCoord > 0;
    }
